...
class Channel(Base):
    ...
    uploads_playlist_id = Column(String, nullable=False, unique=True) # 수집할 영상 목록 ID
...
class Video(Base):
    ...
    # Ops 관점: AI 분석 상태 관리
    analysis_status = Column(String, default='pending', nullable=False) # 'pending', 'completed', 'failed'
